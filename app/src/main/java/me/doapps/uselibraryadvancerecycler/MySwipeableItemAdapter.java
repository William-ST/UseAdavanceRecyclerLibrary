...
public class MySwipeableItemAdapter
    ...
    public int onGetSwipeReactionType(MyViewHolder holder, int position, int x, int y) {
        Log.e(TAG, "onGetSwipeReactionType position: "+position+"   x: "+x+" y:"+y);
    ...
    public int onSwipeItem(MyViewHolder holder, int position, int result) {
        Log.e(TAG, "onSwipeItem(position = " + position + ", result = " + result + ")");
    ...
    public void onPerformAfterSwipeReaction(MyViewHolder holder, int position, int result, int reaction) {
        Log.e(TAG, "onPerformAfterSwipeReaction(position = " + position + ", result = " + result + ", reaction = " + reaction + ")");
        ...
        if (reaction == RecyclerViewSwipeManager.AFTER_SWIPE_REACTION_REMOVE_ITEM) {
            ...
            */
            ...
            //item.setPinnedToSwipeLeft(true); change false - WST [no se va total al lado indicado]
            item.setPinnedToSwipeLeft(false);
            notifyItemChanged(position);
